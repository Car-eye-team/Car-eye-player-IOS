...
@implementation CarEyeAudioPlayer

+ (CarEyeAudioPlayer *) sharedInstance {
    static CarEyeAudioPlayer *player = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        player = [[CarEyeAudioPlayer alloc] init];
    });
...
static OSStatus outputRenderCallback(void                        *inRefCon,
    ...
    CarEyeAudioPlayer *output = (__bridge CarEyeAudioPlayer*)inRefCon;
